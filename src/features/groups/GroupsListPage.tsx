// src/features/groups/GroupsListPage.tsx
import React, { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { Plus, Users, DollarSign, ChevronRight } from 'lucide-react'; // Removed unused Calendar import
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">
                KES {groups.reduce((sum, group) => sum + (group.totalBalance || 0), 0).toLocaleString()}
              </p>
            </div>
